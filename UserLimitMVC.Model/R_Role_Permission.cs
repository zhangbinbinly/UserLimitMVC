...
namespace UserLimitMVC.Model
{
    ...
    public partial class R_Role_Permission: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        #region 基元属性
        ...
        private void FixupBasePermission(BasePermission previousValue)
        {
            ...
            if (previousValue != null && previousValue.R_Role_Permission.Contains(this))
            {
                previousValue.R_Role_Permission.Remove(this);
            }
    
            if (BasePermission != null)
            {
                if (!BasePermission.R_Role_Permission.Contains(this))
                {
                    BasePermission.R_Role_Permission.Add(this);
                }
        ...
        private void FixupBaseRole(BaseRole previousValue)
        {
            ...
            if (BaseRole != null)
            {
                if (!BaseRole.R_Role_Permission.Contains(this))
                {
                    BaseRole.R_Role_Permission.Add(this);
                }
