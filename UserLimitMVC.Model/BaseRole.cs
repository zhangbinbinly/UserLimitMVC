...
namespace UserLimitMVC.Model
{
    ...
    public partial class BaseRole: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        #region 基元属性
        ...
        [DataMember]
        public Nullable<int> OrganizeId
        {
            get { return _organizeId; }
            set
            {
                if (_organizeId != value)
                {
                    _organizeId = value;
        ...
        private Nullable<int> _organizeId;
    
        [DataMember]
        public Nullable<int> CategoryCode
        {
        ...
        private Nullable<int> _categoryCode;
        ...
        private void FixupR_Role_Permission(object sender, NotifyCollectionChangedEventArgs e)
        {
            ...
            if (e.OldItems != null)
            {
                ...
                {
                    if (ReferenceEquals(item.BaseRole, this))
                    {
                        item.BaseRole = null;
                    }
                    if (ChangeTracker.ChangeTrackingEnabled)
